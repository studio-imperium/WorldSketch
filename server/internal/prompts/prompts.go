...
func Scene(scene string, hasGround bool, objectCount ...int) string {
	...
	if hasGround {
		return "Using the same proportions and colors as Image 1, transform the geometric diorama into " + scene + ", in a polished hand-painted stylized isometric game-art style — semi-realistic yet clearly stylized, richly detailed, with soft warm painted lighting, clean readable silhouettes, saturated natural colors, and crisp storybook charm, like a high-quality cozy fantasy builder/RPG game asset. Keep in mind input will be made of cubes/colors, output should be interpreted into an actual diorama without the cube structure. For floor interpret the colors into flat ground terrain: keep the terrain physically flat and level, with no island-like beveled edges, no tapered rim, no raised tabletop, no cliff sides, and no mound or hill shape. Make sure to keep the same scale and spatial positioning of the original geometry in image 1. The diorama should capture a 100mx100m area. hard black background."
	} else {
		return "Using the same proportions and colors as Image 1, transform the geometric diorama into " + scene + ", in a polished hand-painted stylized isometric game-art style — semi-realistic yet clearly stylized, richly detailed, with soft warm painted lighting, clean readable silhouettes, saturated natural colors, and crisp storybook charm, like a high-quality cozy fantasy builder/RPG game asset. Keep in mind input will be made of cubes, output should be interpreted into an actual diorama without the cube structure. No terrain/world, just keep the background black. Make sure to keep the same scale and spatial positioning of the original geometry in image 1. Hard black background."
	}
	// countConstraint := ""
