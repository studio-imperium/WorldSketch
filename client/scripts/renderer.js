...
import { capturePlotGuide, capturePlotPhoto } from "/scripts/capture.js"
...
function syncGenerateButton() {
	...
	// Send is gated on having a target + not already busy; the input stays typeable
	// at all times except mid-generation so a prompt can be drafted ahead of focus.
...
window.addEventListener("keyup", event => {
	...
	if (focusedPlot && !singlePlotMode && document.activeElement !== els.chatInput) exitFocus()
})
